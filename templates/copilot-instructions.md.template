<!--
  Copy to <repo-root>/.github/copilot-instructions.md.

  COMMITTED. A pointer, nothing else: Copilot reads AGENTS.md natively, and
  this file exists for the Copilot surfaces that still read it and for humans
  who look in .github/ first.
-->
