...
<!--
  Copy to <repo>/.github/instructions/status_conduct.instructions.md.
  COMMITTED. The GitHub Copilot twin of .claude/rules/status_conduct.md:
  path-specific instructions that apply when Copilot works on files matching
  applyTo. Per the GitHub docs (checked 2026-08-11), path-specific
  instructions are honored by the Copilot cloud agent and Copilot code
  review; other Copilot surfaces read AGENTS.md, which carries the headlines.
-->
